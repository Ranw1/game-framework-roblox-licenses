...
Double-click [START-WEB.cmd](START-WEB.cmd) in your local copy, with Python 3.10+
installed. The browser opens a private session on this computer. See
[WEB-UI.md](WEB-UI.md) for all workflows and optional private-mirror configuration.

The dashboard supports expiry filters, guided forms, reviewed saves, bulk listing
changes, private history, recovery, and JSON/CSV exports. It does not publish to
GitHub or communicate with game operators.
