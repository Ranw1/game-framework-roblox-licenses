...
Use [WEB-UI.md](WEB-UI.md) and `START-WEB.cmd` for a local browser interface to the
same registry and private history. The instructions below describe the terminal menu.
